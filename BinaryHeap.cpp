...
//parent of ith note will be index i/2
//left child is i*2
...
// //decrease key Therefore, we’ll keep a map data structure beside the original array. 
// This map will store the index of each key inside the heap. 
// Hence, when we need to access a certain key inside the heap, we’ll use this map to determine its index.
